...
public class Number2RMB {
    ...
    private Number2RMB(double amount ) {
        this.amount = amount;
    ...
    public static String toBigAmt(double amount) {
        ...
        if (intPart.length() > 16) throw new java.lang.InternalError("数额太大，无法转换。");
    ...
    private static String getNowGradeVal(String strVal, int grade) {
        ...
        else rst = strVal.substring(strVal.length() - grade * GRADE, strVal.length() - (grade - 1) * GRADE);
        return rst;
    }
